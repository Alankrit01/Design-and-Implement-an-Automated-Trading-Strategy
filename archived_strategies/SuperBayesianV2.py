...
Run:
python main.py --strategy SuperBayesianV2 --data-dir DATA/PART1 --output-dir output/SuperBayes2
'''
...
class SuperBayesian(bt.Strategy):
    ...
    def __init__(self):
        ...
        self.pending_orders = {}
        self.open_positions = {}  # (config_name, data._name)
    ...
    def next(self):
        ...
        # Update selector and weights
        self.selector.step(bar)
        weights = self.selector.get_weights()

        # Market-wide performance for laggard filter
    ...
    def stop(self):
        ...
        Reporting is handled externally in main.py via selector.get_report_data().
        """
        pass
